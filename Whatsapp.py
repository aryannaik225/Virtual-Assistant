...
def sendMessage():
    ...
    if a == "one" or a == "1" or "first" in a:
        ...
        pywhatkit.sendwhatmsg_instantly("+919984624288",message,time_hour=strTime,time_min=update)
        ...
        speak("Whats the message")
        message = icecream.recognize_speech()
        pywhatkit.sendwhatmsg_instantly("+918779067940",message,time_hour=strTime,time_min=update)
        icecream.response_text("Message will be sent in 2 mins")
        speak("Message will be sent in 2 mins")
        pyautogui.press("enter")
